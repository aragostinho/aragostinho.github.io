...
## 1) Configure Certificate Manager on AWS
...
### 1.2) Enter a domain that will use the certificate
...
### 1.6) Send the verification e-mail
...
### 1.7) Receive the verification e-mail
...
## 2) Create an EC2 server running Windows Server 2016
...
### 3.1) Select an Application Load Balancer
